...
import '/view/screens/checkout/widget/condition_check_box.dart';
import '/view/screens/checkout/widget/order_place_button.dart';
import '/view/screens/checkout/widget/partial_pay_view.dart';
    ...
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        ...
        (orderController.orderType != 'take_away' &&
            ...
            ? Row(
                ...
                children: [
                  ...
                  Row(children: [
                    Text('(+) ', style: robotoRegular),
                    PriceConverter.convertAnimationPrice(orderController.tips,
                        textStyle: robotoRegular)
                  ]),
        ...
        Get.find<SplashController>().configModel!.additionalChargeStatus!
            ...
            : const SizedBox(),
        (ResponsiveHelper.isDesktop(context) || orderController.isPartialPay)
            ? Column(
                children: [
                  Divider(
                      thickness: 1,
            ...
            ? Column(children: [
                ...
                Row(
                    ...
                    children: [
                      ...
                      Text(
                          /*subscriptionQty > 0 ? */ subscriptionQty
                              .toString() /* : 'calculating'.tr*/,
                          style: robotoMedium),
                    ]),
                Padding(
                  padding: const EdgeInsets.symmetric(
        ...
        SizedBox(
            height:
                orderController.isPartialPay ? Dimensions.paddingSizeSmall : 0),
        orderController.isPartialPay && !orderController.subscriptionOrder
            ? Row(mainAxisAlignment: MainAxisAlignment.spaceBetween, children: [
