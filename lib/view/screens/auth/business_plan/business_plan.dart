...
import '/data/model/response/package_model.dart';
import '/helper/color_coverter.dart';
...
import '/view/screens/auth/business_plan/widgets/subscription_card.dart';
import '/view/screens/auth/business_plan/widgets/success_widget.dart';
import '/view/screens/auth/widget/registration_stepper_widget.dart';
...
class BusinessPlanScreen extends StatefulWidget {
  ...
  const BusinessPlanScreen({Key? key, required this.restaurantId})
      : super(key: key);
    ...
    return GetBuilder<AuthController>(builder: (authController) {
      return WillPopScope(
        ...
        child: Scaffold(
          ...
          body: authController.businessPlanStatus == 'complete'
              ? const SuccessWidget()
              : Center(
                                  ...
                                  : Padding(
                                      ...
                                      child: Column(children: [
                                        ...
                                        paymentCart(
                                          ...
                                          index: 1,
                                          onTap: () {
                                            authController.setPaymentIndex(2);
                      ...
                      child: SafeArea(
                        child: Padding(
                          ...
                          child: !authController.isLoading
                              ? Row(children: [
                                  (authController.businessPlanStatus ==
                                          'payment')
                                      ? Expanded(
                                          child: InkWell(
                                            onTap: () {
