                                      ...
                                      children: [
                                        Stack(children: [
                                          ClipRRect(
                                            ...
                                            child: CustomImage(
                                              image:
                                                  '${Get.find<SplashController>().configModel!.baseUrls!.productImageUrl}/${productList[index].image}',
                                              height: 125,
                                              width: 170,
                                              fit: BoxFit.cover,
                                            ),
...
class BestReviewedItemShimmer extends StatelessWidget {
  ...
  const BestReviewedItemShimmer({Key? key, required this.productController})
      : super(key: key);
