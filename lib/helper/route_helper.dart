...
import '/view/screens/auth/business_plan/business_plan.dart';
import '/view/screens/auth/business_plan/subscription_success_screen.dart';
import '/view/screens/auth/delivery_man_registration_screen.dart';
import '/view/screens/auth/restaurant_registration_screen.dart';
...
import '/view/screens/chat/conversation_screen.dart';
...
import '/view/screens/checkout/payment_webview_screen.dart';
import '/view/screens/coupon/coupon_screen.dart';
import '/view/screens/cuisine/cuisine_restaurant_screen.dart';
import '/view/screens/cuisine/cuisine_screen.dart';
...
import '/view/screens/home/map_view_screen.dart';
...
import '/view/screens/order/refund_request_screen.dart';
...
class RouteHelper {
  ...
  static String getPaymentRoute(OrderModel orderModel, String? paymentMethod,
      {String? addFundUrl, String? subscriptionUrl}) {
  ...
  static String getPopularFoodRoute(bool isPopular,
      ...
      '$popularFoods?page=${isPopular ? 'popular' : 'reviewed'}&fromIsRestaurantFood=${fromIsRestaurantFood.toString()}';
  ...
  static List<GetPage> routes = [
    ...
    GetPage(
        name: popularFoods,
        page: () => getRoute(PopularFoodScreen(
