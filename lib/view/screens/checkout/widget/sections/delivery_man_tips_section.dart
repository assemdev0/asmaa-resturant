...
import '/view/screens/checkout/widget/tips_widget.dart';
...
class _DeliveryManTipsSectionState extends State<DeliveryManTipsSection> {
  ...
  Widget build(BuildContext context) {
    ...
    return Column(
      children: [
        (!widget.orderController.subscriptionOrder &&
                !widget.takeAway &&
                ...
                child: Column(
                    ...
                    children: [
                      Row(children: [
                        ...
                        (widget.orderController.selectedTips ==
                            ...
                            : SizedBox(
                                ...
                                child: ListTile(
                                  onTap: () =>
                                      widget.orderController.toggleDmTipSave(),
                                  trailing: Checkbox(
                      ...
                      SizedBox(
                        height: (widget.orderController.selectedTips ==
                                    AppConstants.tips.length - 1) &&
                                widget.orderController.canShowTipsField
                            ? 0
                            : 60,
                        child: (widget.orderController.selectedTips ==
                                    AppConstants.tips.length - 1) &&
                                widget.orderController.canShowTipsField
                            ? const SizedBox()
                            : ListView.builder(
                                ...
                                itemBuilder: (context, index) {
                                  return TipsWidget(
                                    ...
                                    onTap: () {
                                      total =
                                          total - widget.orderController.tips;
                                      widget.orderController.updateTips(index);
                                      if (widget.orderController.selectedTips !=
                                          AppConstants.tips.length - 1) {
                                        widget.orderController.addTips(
                                            double.parse(
                                                AppConstants.tips[index]));
                                      }
                                      if (widget.orderController.selectedTips ==
                                      ...
                                      widget.orderController.tipController
                                              .text =
                                          widget.orderController.tips
                                              .toString();
                                      if (widget.orderController.isPartialPay ||
                                      ...
                                      try {
                                        if (double.parse(value) >= 0) {
                                          ...
                                          if (Get.find<UserController>()
                                            ...
                                            widget.orderController
                                                .checkBalanceStatus(total);
                                            canCheckSmall = true;
                                          } else if (Get.find<UserController>()
                                                      .userInfoModel!
                                                      .walletBalance! >
                                                  total &&
                                              canCheckSmall &&
                                        ...
                                        widget.orderController.tipController
                                            ...
                                            TextSelection.collapsed(
                                                offset: widget.orderController
                                                    .tipController.text.length);
                                      }
                                    } else {
                                      widget.orderController.addTips(0.0);
                                    }
