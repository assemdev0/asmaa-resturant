...
import '/view/screens/cart/widget/cart_product_widget.dart';
import '/view/screens/cart/widget/not_available_bottom_sheet.dart';
import '/view/screens/checkout/widget/delivery_instruction_view.dart';
...
class _CartScreenState extends State<CartScreen> {
                                                                  ...
                                                                  Center(
                                                                    child:
                                                                      ...
                                                                      onPressed:
                                                                          () {
                                                                        Get.toNamed(
                                                                          RouteHelper.getRestaurantRoute(cartController
                                                                              .cartList[0]
                                                                              .product!
                                                                              .restaurantId),
                                                                          arguments:
                                                                              RestaurantScreen(restaurant: Restaurant(id: cartController.cartList[0].product!.restaurantId)),
                                                                        );
                                                                      },
                                                                      icon: Icon(
                                                                          Icons
    ...
    return Container(
      ...
      child: GetBuilder<RestaurantController>(builder: (restaurantController) {
        return Column(children: [
          ...
          !isDesktop
              ? cutleryView(restaurantController, cartController)
              : const SizedBox(),
          !isDesktop
              ? notAvailableProductView(cartController)
              : const SizedBox(),
  ...
  Widget cutleryView(RestaurantController restaurantController,
      CartController cartController) {
    bool isDesktop = ResponsiveHelper.isDesktop(context);
        ...
        child: GetBuilder<RestaurantController>(builder: (storeController) {
          ...
          return Column(
            ...
            children: [
              ...
              SizedBox(
                  height: isDesktop ? Dimensions.paddingSizeExtraLarge : 0),
            ],
          );
        }),
      ),
