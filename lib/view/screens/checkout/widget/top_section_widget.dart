...
import '/view/base/custom_dropdown.dart';
import '/view/base/custom_snackbar.dart';
import '/view/base/custom_text_field.dart';
import '/view/screens/address/widget/address_widget.dart';
import '/view/screens/cart/widget/delivery_option_button.dart';
import '/view/screens/checkout/widget/order_type_widget.dart';
import '/view/screens/checkout/widget/sections/coupon_section.dart';
import '/view/screens/checkout/widget/sections/delivery_man_tips_section.dart';
import '/view/screens/checkout/widget/sections/payment_section.dart';
import '/view/screens/checkout/widget/sections/time_slot_section.dart';
import '/view/screens/checkout/widget/subscription_view.dart';
              ...
              children: [
                SizedBox(
                    height: !isDesktop &&
                        ...
                        : 0),
                isCashOnDeliveryActive && restaurantSubscriptionActive
                    ? Container(
                        width: context.width,
                        ...
                        margin: EdgeInsets.symmetric(
                            horizontal:
                                isDesktop ? 0 : Dimensions.fontSizeDefault),
                ...
                /// Time Slot
                if (orderController.orderType != 'dinein')
                  TimeSlotSection(
                    fromCart: fromCart,
                    orderController: orderController,
                                    ...
                                    if (value == -1) {
                                      ...
                                      _checkPermission(() async {
                                        ...
                                        if (addressModel.zoneIds!.isNotEmpty) {
                                          restController.insertAddresses(
                                      ...
                                      orderController
                                          ...
                                          restController.address[value].road ??
                                              '';
                                      orderController.houseController.text =
                                          restController.address[value].house ??
                                              '';
                                      orderController.floorController.text =
                                          restController.address[value].floor ??
                                              '';
                                    }
                                  },
                                ...
                                children: [
                                  ResponsiveHelper.isDesktop(context)
                                      ? Expanded(
                                          child: CustomTextField(
                                            ...
                                            focusNode:
                                                orderController.streetNode,
                                            nextFocus:
                                                orderController.houseNode,
                                            controller: orderController
                                                .streetNumberController,
                                            showTitle:
                                  ...
                                  Expanded(
                                    child: CustomTextField(
                                      ...
                                      controller:
                                          orderController.houseController,
                                      showTitle:
                                          ResponsiveHelper.isDesktop(context),
                                    ),
                                  ),
                                  ...
                                  Expanded(
                                    child: CustomTextField(
                                      ...
                                      controller:
                                          orderController.floorController,
                                      showTitle:
                                          ResponsiveHelper.isDesktop(context),
                                    ),
                                  ),
                ...
                if (orderController.orderType == 'dinein')
                  Container(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Text('table_number'.tr, style: robotoMedium),
                        const SizedBox(height: Dimensions.paddingSizeDefault),
                        CustomTextField(
                          titleText: 'table_number'.tr,
                          inputType: TextInputType.number,
                          inputAction: TextInputAction.done,
                          controller: orderController.tableNumberController,
