...
import '/view/screens/location/widget/location_search_dialog.dart';
...
class AddAddressScreen extends StatefulWidget {
  ...
  const AddAddressScreen(
      {Key? key, required this.fromCheckout, this.zoneId, this.address})
      : super(key: key);
...
class _AddAddressScreenState extends State<AddAddressScreen> {
  ...
  Widget addressSectionWidget(LocationController locationController) {
    return Container(
      ...
      child: Column(crossAxisAlignment: CrossAxisAlignment.start, children: [
        Container(
          height: ResponsiveHelper.isDesktop(context) ? 260 : 145,
  ...
  Widget informationSectionWidget(LocationController locationController) {
    return Container(
      decoration: ResponsiveHelper.isDesktop(context)
          ? BoxDecoration(
              color: Theme.of(context).cardColor,
  ...
  Widget saveButton(LocationController locationController) {
    return Container(
      width: Dimensions.webMaxWidth,
      padding: EdgeInsets.all(ResponsiveHelper.isDesktop(context)
          ? 0
