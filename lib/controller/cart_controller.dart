  ...
  double calculationCart() {
    ...
    for (var cartModel in _cartList) {
      ...
      if (Get.find<RestaurantController>().restaurant != null &&
        ...
        double? dis = (Get.find<RestaurantController>().restaurant!.discount !=
                    null &&
                DateConverter.isAvailable(
                    ...
                    Get.find<RestaurantController>()
                        ...
                        .discount!
                        .endTime))
            ? Get.find<RestaurantController>().restaurant!.discount!.discount
        ...
        if (Get.find<RestaurantController>()
            ...
            Get.find<RestaurantController>()
                    ...
                    .maxDiscount! <
                _itemDiscountPrice) {
          _itemDiscountPrice = Get.find<RestaurantController>()
              .restaurant!
              .discount!
              .maxDiscount!;
        }
    ...
    for (int index = 0; index < _cartList.length; index++) {
      if (_cartList[index].product!.id == product.id) {
        if (_cartList[index].product!.variations![0].multiSelect != null) {
          if (_cartList[index].product!.variations![0].multiSelect ==
              product.variations![0].multiSelect) {
            return index;
          }
        } else {
          return index;
