...
import '/helper/link_converter.dart';
...
import '/view/screens/refer_and_earn/widget/bottom_sheet_view.dart';
...
class _ReferAndEarnScreenState extends State<ReferAndEarnScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    String initialLink =
        'StackFood://stackfood.com/category-product?id=5&name=QnVyZ2Vy';
                            ...
                            return Column(
                                ...
                                children: [
                                  ...
                                  Wrap(children: [
                                    ...
                                    //
                                    // InkWell(
                                    //   onTap: () => onButtonTap(ShareType.facebook, userController.userInfoModel!.refCode!),
                                    //     child: Image.asset(Images.facebookIcon, height: 40, width: 40),
                                    // ),
