...
import '/view/screens/chat/widget/image_dialog.dart';
import '/view/screens/order/widget/delivery_details.dart';
import '/view/screens/order/widget/log_dialog.dart';
import '/view/screens/order/widget/order_product_widget.dart';
import '/view/screens/restaurant/widget/review_dialog.dart';
...
/*                          const SizedBox(
          ...
          Container(
            ...
            child:
              ...
              Row(children: [
                Text('${subscription ? 'subscription_id'.tr : 'order_id'.tr}:',
                    style: robotoRegular),
                      ...
                      children: [
                          ...
                          Row(children: [
                            Expanded(
                              ...
                              height: 35,
                              onPressed: () => Get.dialog(LogDialog(
                ...
                child: Column(
                    ...
                    children: [
                      !isDesktop
                          ...
                          : const SizedBox(),
                      SizedBox(
                          height: !isDesktop ? Dimensions.paddingSizeSmall : 0),
                      Row(children: [
                        ClipOval(
                            child: CustomImage(
                          image:
