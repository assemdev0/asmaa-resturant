...
import '/view/screens/checkout/helper/checkout_helper.dart';
import '/view/screens/checkout/widget/bottom_section_widget.dart';
import '/view/screens/checkout/widget/order_place_button.dart';
import '/view/screens/checkout/widget/top_section_widget.dart';
  ...
  void initCall() {
    if (Get.find<AuthController>().isLoggedIn()) {
      Get.find<OrderController>().streetNumberController.text =
          Get.find<LocationController>().getUserAddress()!.road ?? '';
      ...
      Get.find<CouponController>()
          .getCouponList(restaurantId: _cartList[0].product!.restaurantId);
                ...
                return GetBuilder<CouponController>(
                  ...
                  return GetBuilder<OrderController>(
                    ...
                    if (restController.restaurant != null &&
                      ...
                      charge = CheckoutHelper.getDeliveryCharge(
                          restController: restController,
                          orderController: orderController,
                          returnDeliveryCharge: false);
                      maxCodOrderAmount = CheckoutHelper.getDeliveryCharge(
                          restController: restController,
                          orderController: orderController,
                    ...
                    if (restController.restaurant != null) {
                      ...
                      subscriptionQty = CheckoutHelper.getSubscriptionQty(
                          orderController: orderController,
                          restaurantSubscriptionActive:
                              restaurantSubscriptionActive);
                    ...
                    double total = subTotal +
                        ...
                        couponDiscount! +
                        (taxIncluded ? 0 : tax) +
                        (showTips ? orderController.tips : 0) +
                        additionalCharge;
