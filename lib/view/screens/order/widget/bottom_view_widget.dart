...
import '/view/screens/order/widget/cancellation_dialogue.dart';
import '/view/screens/order/widget/subscription_pause_dialog.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Column(children: [
                      ...
                      !subscription &&
                          ...
                          ? Expanded(
                              child: CustomButton(
                                ...
                                onPressed: () => orderController.reOrder(
      ...
      Builder(builder: (context) {
        return ((order.orderStatus == 'failed' || cancelled) &&
                !cod &&
