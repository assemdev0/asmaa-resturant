...
import '/view/screens/wallet/widget/fund_payment_dialog.dart';
...
class PaymentScreenState extends State<PaymentScreen> {
  ...
  void initState() {
    ...
    if (widget.addFundUrl == '' &&
      ...
      selectedUrl =
          '${AppConstants.baseUrl}/payment-mobile?customer_id=${widget.orderModel.userId}&order_id=${widget.orderModel.id}&payment_method=${widget.paymentMethod}';
  ...
  Future<bool?> _exitApp() async {
    ...
    if (widget.addFundUrl == null &&
      ...
      return Get.dialog(FundPaymentDialog(
      ...
      if ((addFundUrl == '' &&
        ...
        if (isSuccess || isFailed || isCancel) {
          ...
          if (subscriptionUrl != null &&
              ...
              addFundUrl!.isEmpty) {
            print('---here--- 3  now');
            Get.toNamed(RouteHelper.getSubscriptionSuccessRoute(isSuccess
                ? 'success'
                : isFailed
                    ? 'fail'
                    : 'cancel'));
