...
import '/view/screens/coupon/widget/coupon_card.dart';
                                  ...
                                  if (couponController.discount! < 1 &&
                                    ...
                                    if (orderController
                                      ...
                                      couponController
                                          ...
                                          .then((discount) {
                                        orderController.couponController.text =
                                            '${orderController.couponController.text}(${couponController.freeDelivery ? 'free_delivery'.tr : PriceConverter.convertPrice(couponController.discount)})';
                                        if (discount! > 0) {
