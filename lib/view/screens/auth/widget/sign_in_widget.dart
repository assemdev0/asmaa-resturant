...
import '/view/screens/auth/widget/guest_button.dart';
import '/view/screens/auth/widget/social_login_widget.dart';
      ...
      return Column(
          ...
          children: [
            ...
            CustomButton(
              ...
              buttonText:
                  ResponsiveHelper.isDesktop(context) ? 'login' : 'sign_in'.tr,
