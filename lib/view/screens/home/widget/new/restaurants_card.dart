...
import '/view/screens/home/widget/new/icon_with_text_row_widget.dart';
import '/view/screens/home/widget/new/overflow_container.dart';
...
class RestaurantsCard extends StatelessWidget {
  ...
  const RestaurantsCard(
      {Key? key, this.isNewOnStackFood, required this.restaurant})
      : super(key: key);
                ...
                Stack(
                  children: [
                    Container(
                      ...
                      height: isNewOnStackFood! ? 98 : 78,
                      width: isNewOnStackFood! ? 98 : 78,
                      decoration: BoxDecoration(
                        color: Theme.of(context).cardColor,
                        borderRadius:
                  ...
                  child: Column(
                    ...
                    children: [
                      Text(
                        ...
                        maxLines: 1,
                        style:
                            robotoMedium.copyWith(fontWeight: FontWeight.w600),
                      ),
                                ...
                                child: Stack(children: [
                                  ...
                                  restaurant.foods!.length > 1
                                      ? Positioned(
                                          left: 22,
                                          bottom: 0,
                                          child: OverFlowContainer(
                                              image:
                                                  restaurant.foods![1].image ??
                                                      ''),
                                        )
                                      : const SizedBox(),
...
class RestaurantsCardShimmer extends StatelessWidget {
  final bool? isNewOnStackFood;
  const RestaurantsCardShimmer({Key? key, this.isNewOnStackFood})
      : super(key: key);
